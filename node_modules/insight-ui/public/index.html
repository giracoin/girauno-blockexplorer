...
<head>
  <base href="/" />
	...
	<title data-ng-bind="$root.title + $root.titleDetail + ' | Insight'">Giracoin</title>
	<meta name="description" content="Giracoin Insight. View detailed information on all Giracoin transactions and block. {{ $root.title + $root.titleDetail }}">
...
<body ng-cloak class="ng-cloak">
  <div>
    ...
    <div class="container" data-ng-controller="FooterController">
      ...
      <a class="insight m10v pull-right" target="_blank" href="https://giracoin.com">Giracoin <small>v1.0</small></a>
    </div>
  </div>
