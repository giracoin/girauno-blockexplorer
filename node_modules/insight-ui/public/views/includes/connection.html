<div class="connection-status container" data-ng-controller="ConnectionController">
  ...
  <div class="alert alert-danger" 
    ...
    <p data-ng-show="!apiOnline" translate>
      Can't connect to giracoind to get live updates from the p2p network. (Tried connecting to blockchain at {{host}}:{{port}} and failed.)
    </p>

    <p data-ng-show="!serverOnline" translate>
      Can't connect to API server. Attempting to reconnect... 
    </p>
